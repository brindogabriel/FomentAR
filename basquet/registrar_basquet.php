...
elseif ($sexo == "1" && $diferencia_anios >= 13 && $diferencia_anios <= 15 ) {
	$idCategoria = 3;
}
elseif ($sexo == "2" && $diferencia_anios >= 13 && $diferencia_anios <= 17 ) {
	$idCategoria = 4;
...
elseif ($sexo == "1" && $diferencia_anios >= 20 && $diferencia_anios <= 45 ) {
	$idCategoria = 6;
}
