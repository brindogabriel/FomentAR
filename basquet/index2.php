            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="formlogin">
                            <form action="registrar_basquet.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select simple class="form-control" id="exampleFormControlSelect" name="socio"
                                        required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select simple class="form-control" id="exampleFormrControlSelect" name="Sexo"
                                        required>
                    ...
                    >>>>>>> 48ca12c27cf1536d0610c75976c67c2e942722c1:basquet/index.php
                </div>
            </div>
        </div>
