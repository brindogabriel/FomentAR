...
ALTER TABLE `Transacciones`
ADD COLUMN tipo_pago ENUM('cuota', 'alquiler') NOT NULL AFTER TipoTransaccion,
ADD COLUMN estado_pago ENUM('pagado', 'no pagado') NOT NULL AFTER tipo_pago,
ADD COLUMN es_socio TINYINT(1) NOT NULL AFTER estado_pago;
