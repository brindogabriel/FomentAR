...
INSERT INTO `eventos` (`idevento`, `nombre`, `fecha_inicio`, `fecha_fin`, `estado`, `pagado`, `importe`) VALUES
(2, 'test', '2022-06-26 16:42:19', '2022-06-27 16:37:19', 1, 0, 0);
...
INSERT INTO `eventos_estado` (`estado`, `descripcion`) VALUES
(1, 'falta'),
(2, 'ya pasó'),
(3, 'esta pasando');
...
INSERT INTO `facturacion` (`idFacturacion`, `Nro_orden`, `idDisciplina`, `Anio`, `Mes`, `Pago`) VALUES
(1, 2, 6, 0, 0, 0);
...
--
ALTER TABLE `facturacion`
  MODIFY `idFacturacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `eventos`
  ADD CONSTRAINT `eventos_ibfk_1` FOREIGN KEY (`estado`) REFERENCES `eventos_estado` (`estado`);
